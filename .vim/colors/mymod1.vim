...
call <SID>X("Comment","0000cd","","none")
call <SID>X("Conditional","e2e4e5","","none")
call <SID>X("Constant","ff1493","","none")
call <SID>X("Cursor","e2e4e5","","none")
...
call <SID>X("DiffAdd","ffffff","90ee90","none")
call <SID>X("DiffChange","ffffff","b4cdcd","none")
call <SID>X("DiffDelete","000000","8b0000","none")
call <SID>X("DiffText","3f1f1f","","none")
...
call <SID>X("FoldColumn","00ffff","1f0f0f","none")
call <SID>X("Folded","00ffff","333333","none")
call <SID>X("Function","3f1f1f","","none")
call <SID>X("Identifier","005f5f","","none")
call <SID>X("Ignore","e2e4e5","","none")
call <SID>X("IncSearch","e2e4e5","","none")
call <SID>X("Include","e2e4e5","","none")
call <SID>X("Keyword","3f1f1f","","none")
call <SID>X("Label","e2e4e5","","none")
call <SID>X("LineNr","3f1f1f","ffe4b5","none")
call <SID>X("LocalVariable","e2e4e5","","none")
call <SID>X("Macro","e2e4e5","","none")
call <SID>X("MatchParen","e2e4e5","deb887","none")
call <SID>X("ModeMsg","e2e4e5","","none")
call <SID>X("MoreMsg","e2e4e5","","none")
call <SID>X("NonText","a52a2a","ffe4b5","none")
call <SID>X("Normal","3f1f1f","c9d4e0","none")
call <SID>X("Number","3f1f1f","","none")
call <SID>X("Operator","3f1f1f","","none")
call <SID>X("PMenu","000000","bebebe","none")
call <SID>X("PMenuSbar","000000","1f0f0f","none")
call <SID>X("PMenuSel","8b4726","ffffff","none")
call <SID>X("PMenuThumb","000000","ee3b3b","none")
call <SID>X("PreCondit","e2e4e5","","none")
call <SID>X("PreProc","8b008b","","none")
call <SID>X("Question","e2e4e5","","none")
call <SID>X("Repeat","e2e4e5","","none")
call <SID>X("Search","0000ff","cdad00","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","3f1f1f","","none")
...
call <SID>X("Statement","8b0000","","none")
call <SID>X("StatusLine","5f3705","ffffff","bold")
call <SID>X("StatusLineNC","3f1f1f","bebebe","none")
call <SID>X("StorageClass","e2e4e5","","none")
call <SID>X("String","3f1f1f","","none")
...
call <SID>X("Todo","3f1f1f","","none")
call <SID>X("Type","31a631","","none")
call <SID>X("Typedef","e2e4e5","","none")
call <SID>X("Underlined","e2e4e5","","none")
call <SID>X("Union","e2e4e5","","none")
call <SID>X("VertSplit","e2e4e5","bebebe","none")
...
call <SID>X("pythonBuiltin","3f1f1f","","none")
